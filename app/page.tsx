...
async function saveDialer(data:any){if(operator)await saveDialerFor(operator.id,data)}
 ...
 return <div className="app">
  ...
  <main className="content">
   ...
   {mode==="crm"&&<CRM leads={leads} stages={stages} onMove={moveLead} onOpen={setSelectedLead}/>}   {mode==="resultados"&&<OperationalResults leads={leads} onOpen={setSelectedLead}/>}
